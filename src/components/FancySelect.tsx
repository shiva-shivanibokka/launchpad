  ...
  return (
    <>
      <button
        ...
        aria-expanded={open}
        onClick={toggle}
        className={`inline-flex w-full items-center gap-2 rounded-lg border border-white/10 bg-white/[0.04] px-3.5 py-2.5 text-left font-sans text-[16px] text-ink outline-none transition hover:border-white/25 focus:border-accent-violet/60 ${
            ...
            {includeClear && (
              <li>
                <button
                  ...
                  className="flex w-full items-center gap-2.5 rounded-lg px-3 py-2.5 text-[15px] text-faint transition hover:bg-white/[0.07]"
                >
            ...
            {options.map((o) => (
              <li key={o.value}>
                <button
                  ...
                  className={`flex w-full items-center gap-2.5 rounded-lg px-3 py-2.5 text-[15px] font-medium transition hover:bg-white/[0.07] ${
