              ...
              {rows.map((r, i) => (
                <tr key={r.resume.id} className="border-t border-white/8">
                  <td className="py-2.5 pr-3">
                    <span className="font-sans text-[16.5px] font-semibold text-ink">{r.resume.name}</span>
                    {i === 0 && r.applied > 0 && (
                  ...
                  <td className="px-3 font-mono text-[16.5px] text-subtle">{r.applied}</td>
                  <td className="px-3 font-mono text-[16.5px] text-subtle">{r.responded}</td>
                  <td className="px-3 font-mono text-[16.5px] text-subtle">{r.interviewed}</td>
                  <td className="px-3 font-mono text-[16.5px] text-subtle">{r.offers}</td>
